  ...
  Widget _buildMenu(BoxConstraints c) {
    ...
    return Container(
      ...
      child: SafeArea(child: Column(children: [
        ...
        const Spacer(flex: 2),
        Image.asset('assets/chrome_rush_title.png', width: c.maxWidth * 0.85, fit: BoxFit.contain),
        ...
        Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            GestureDetector(
              onTap: () => launchUrl(Uri.parse(policyPageUrl), mode: LaunchMode.externalApplication),
            ...
            GestureDetector(
              onTap: () => launchUrl(Uri.parse(helpPageUrl), mode: LaunchMode.externalApplication),
